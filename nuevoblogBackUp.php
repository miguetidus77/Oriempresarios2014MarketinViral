...
<body>
	<h1>Sistema Entrada Nuevos Artículos OriEmpresarios.com</h1>

	<section id="formBlog">
		<form method="POST" name="formblog" action="uploadblog.php">
			<div id="datosBlog">
				<div>
					<label for="titulo">Titulo Artículo</label>
					<input type="text" name="tituloEntrada" id="titulo" maxlength="100">
				</div>
				<div><label for="articuloDate">Fecha Entrada:</label>
				<input type="text" name="articuloDate" id="articuloDate" max-length="16" />
				</div>
				</div>
			<div>
			
			<textarea id="hiddenCopyEditable" name="hiddenCopyEditable" style="display:none;" ></textarea>
			<input type="hidden" name="entrieIdentifier" id="entrieIdentifier" size="24" />	
			
			<input type="submit" name="saveButton" value="Guardar" id="saveButton" />
	...
	<section id="textFormat">
		...
		<tbody>
			<tr>
				...
				<!--<td>
					<button id="backButton" type="button" title="Cambia el color de fondo">Back</button>
				</td>-->
				<td>
					<div id="fontColor">
						<table>
				...
				<!--<td>
					<button type="button" id="showVideoBoxUp" title="Insertar Video">Video</button>
				</td>-->
				<!--<td>
					<div id="videoUp">						
						<form action="" method="post" id="videoUpload" enctype="multiparta/form-data">
							<div id="inputsBox">
								<label class="fileLabel"><p>Selecciona Video</p>
									<input type="file" class="fileUp" name="fileUp[]" multiple="multiple"/><!--<a href="#" id="plusfile">Añadir otro archivo</a><br />-->
								<!--</label>
							</div>
							<hr>
							<button type="submit" id="subir" value="Subir Archivos" name="Subir"/>Subir Archivos</button>
						<!--</form>						
						<div id="showUploadVideo">
						<progress class="imagePrebarr" value="0" max="100" style="width:100px;"></progress>
																
						</div>
						<hr>
						<div class="insertBox">
							<label class="insertLabel"><p>Insertar Video</p>
								<button type="button" id="insertVideo" title="Insertar Video">Insertar Video</button>
							</label>
						</div>
					</div>
				</td>-->
	...
	<script>
		...
		//---------------------------------------------------------------
			$("#colorButton").click(function(){
				$("#fontColor").css("left","11em").slideDown(200);
	...
	//-------------------------------------------------------------------------
		...
		//------------------------------------------------------------------------------
			...
			$("#saveButton").click(function(e){
				...
				var hidden=identifierRandomEntrie();
				$("#entrieIdentifier").val(hidden);
				console.log(identifierRandomEntrie());
			});
		//------------------------------------------------------------------------------
